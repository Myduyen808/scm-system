            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('supplier.products.updateStock', $product->id) }}" method="POST" class="d-flex">
                                @csrf @method('PUT')
                                <input type="number" name="stock_quantity" value="{{ $product->stock_quantity }}" class="form-control w-50 me-2">
