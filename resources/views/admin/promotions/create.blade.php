...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="text-muted">Điền thông tin để tạo một chương trình khuyến mãi mới.</p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="discount" id="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount') }}" step="0.01" min="0" max="100" required>
                            @error('discount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="is_active" id="is_active" class="form-control">
                                ...
                                <option value="0" {{ old('is_active', 1) == 0 ? 'selected' : '' }}>Tắt</option>
                            </select>
                        </div>
